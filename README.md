...
Speaking of VM files.... You have to download the game by zipping or cloning it from this repo and open the `vm` sub-directory in it in your emulator. You might have to select the VM files manually, or just the directory, depending on the software you choose. 
